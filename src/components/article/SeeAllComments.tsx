...
import type { Comment, ComponentArticleCardProps } from "@/types/blog";
// Dummy data for demonstration, replace with props/comment from parent

export default function SeeAllcommentModal() {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-0">
          <DialogPanel className="relative w-full max-w-lg bg-white rounded-xl shadow-xl p-0">
            ...
            <div className="px-6 pb-6 pt-2 max-h-96 overflow-y-auto">
              {comment.map((c: ComponentArticleCardProps, idx: number) => (
                <div
                  key={c.id}
